package org.smms.common.handler;

import java.sql.SQLException;
import java.util.Objects;

import org.smms.common.exception.ValidationException;
...
/**
 * Глобальный обработчик исключений для REST-контроллеров макета соцсети
 */
@Slf4j
...
public class GlobalRestExceptionHandler {
    ...
    private static final String USER_NOT_FOUND_MESSAGE = "Запрещен доступ, не найден пользователь с таким логином";
    ...
    */
    ...
    public ResponseEntity<String> handleJwtException(JwtException ex) {
        ...
        /**
    * @param ex {@link UsernameNotFoundException}.
    * @return {@link ResponseEntity} с текстом ошибки {@link USER_NOT_FOUND_MESSAGE} и HttpStatus.BAD_REQUEST.
    */
    @ExceptionHandler(UsernameNotFoundException.class)
    public ResponseEntity<String> handleJwtException(UsernameNotFoundException ex) {
        final String message = ex.getMessage();
        log.error(message, ex);
        return new ResponseEntity<>(USER_NOT_FOUND_MESSAGE, HttpStatus.BAD_REQUEST);
    }
